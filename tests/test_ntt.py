...
class TestNtt:
    ...
    @pytest.mark.parametrize(
        "input,expected", [
            ...
            ([1, 2, 3, 4, 5, 0, 0, 0], [15, 443713764, 173167439, 730825730, 3, 35028273, 825076920, 786920923]),
        ]
    )
    ...
    @pytest.mark.parametrize(
        "input,expected", [
            ...
            ([15, 443713764, 173167439, 730825730, 3, 35028273, 825076920, 786920923], [1, 2, 3, 4, 5, 0, 0, 0]),
        ]
    )
