...
def pytest_configure(config):
    config.addinivalue_line("markers", "file(name,function,code): mark test to run only on named environment")
    config.addinivalue_line("markers", "license(enable,kwargs): mark test to run only on named environment")
    config.addinivalue_line("markers", "package(name,function,code): mark test to run only on named environment")
